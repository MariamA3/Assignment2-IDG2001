...
## Mariam
- cache, load balancer og like batching 
- Gotta fix this somehow, when try to import database, it doesnt work, so having db connection here is the only way it works for some reason.
